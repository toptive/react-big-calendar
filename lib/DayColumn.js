...
var _EventsMultipleWeek = _interopRequireDefault(
  require('./EventsMultipleWeek')
)
  ...
  (function(_React$Component) {
    ...
    function DayColumn() {
      ...
      _this.renderEvents = function() {
        ...
        if (
          view === _constants.views.WEEK ||
          view === _constants.views.WORK_WEEK
        ) {
          var groups = {}
          ...
          var styledSingleEvents = DayEventLayout.getStyledEvents({
            events: singleEvent,
            accessors: accessors,
          ...
          return _react.default.createElement(
            ...
            multipleEvents.map(function(events, idx) {
              ...
              return _react.default.createElement(
                _EventsMultipleWeek.default,
                props
              )
            })
          )
        } else {
          var styleEvent = DayEventLayout.getStyledEvents({
            events: events,
            accessors: accessors,
            slotMetrics: slotMetrics,
            minimumStartDifference: Math.ceil((step * timeslots) / 2),
